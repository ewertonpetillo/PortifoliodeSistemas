<?php	
   ...
   $mes = $_GET['mes'];
    ...
    $query = "SELECT * FROM tb_frequencia p INNER JOIN tb_aluno a on (a.id_aluno = p.aluno_frequencia) INNER JOIN tb_turma b on (b.id_turma = a.turma_aluno) WHERE b.id_turma = '$idturma' and p.mes_frequencia = '$mes1' order by a.nome_aluno";

    $query1 = "SELECT * FROM tb_frequencia p INNER JOIN tb_aluno a on (a.id_aluno = p.aluno_frequencia) INNER JOIN tb_turma b on (b.id_turma = a.turma_aluno) WHERE b.id_turma = '$idturma' and p.mes_frequencia = '$mes2' order by a.nome_aluno";
	...
	$mpdf->WriteHTML('
		...
		<div class="container-fluid logo">
		  ...
		  <div class="box" align="justify">
		        ...
		        <h5 align="center"><B><u>'.$turma.' - Prof. '.$prof.' - '.$turno.'</u></B></h5>
